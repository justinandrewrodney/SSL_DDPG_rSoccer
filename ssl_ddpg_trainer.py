...
class NewMLPActorCritic(torch.nn.Module):
    ...
    def __init__(self, observation_space, action_space, hidden_sizes=(256,256),
        ...
        self.pi = torch.jit.script( NewMLPActor(obs_dim, act_dim, hidden_sizes, activation, act_limit))
...
def ddpg(env_fn, actor_critic=NewMLPActorCritic, ac_kwargs=dict(), seed=0, 
...
if __name__ == '__main__':
    ...
    ddpg(lambda : gym.make(args.env), actor_critic=NewMLPActorCritic,
